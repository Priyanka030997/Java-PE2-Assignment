...
public class CheckGivenNumberisPowerOf4Test {
    ...
    {
        boolean result=obj.GivenNumberisPower0f4ornot(64);
        assertEquals(true,result);
    }
    @Test
    public void GivenNumberisNotPowerOf4()
    {
        boolean result=obj.GivenNumberisPower0f4ornot(70);
        assertEquals(false,result);
    }
    @Test
    public void GivenNumberisOdd()
    {
        boolean result=obj.GivenNumberisPower0f4ornot(31);
        assertEquals(false,result);
    }
    @Test
    public void GivenNumberisZero()
    {
        boolean result=obj.GivenNumberisPower0f4ornot(0);
        assertEquals(false,result);
    }
